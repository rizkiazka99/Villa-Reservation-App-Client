...
import 'package:reservilla/data/models/contents/villas/villa_search_response.dart' as searchedVillas;
...
class SearchedVillaCard extends StatefulWidget {
  final List<searchedVillas.Datum> villa;

  const SearchedVillaCard(this.villa, {super.key});

  @override
  State<SearchedVillaCard> createState() => _SearchedVillaCardState();
}

class _SearchedVillaCardState extends State<SearchedVillaCard> {
  @override
  Widget build(BuildContext context) {
    return Column(
      children: List.generate(
