        ...
        Container(
          ...
          child: CountdownTimer(
            ...
            widgetBuilder: (context, time) {
              if (time == null) {
                return Center(
                  child: Text('00 : 00 : 00', style: h4(color: contextRed)),
                );
              } else {
                if (time.days != null) {
                  return Center(
                  ...
                  return Center(
                    child: Text('${time.hours} : ${time.min} : ${time.sec}',
                        style: h4(color: contextRed)),
                  );
                }
              }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: backButton(),
        title: Obx(() => controller.bookingDetailLoading
            ? const Text('Booking')
            : Text('Booking ${controller.bookingDetailData!.data.id}')),
              ...
              child: Column(
                children: [
                  SizedBox(
                    ...
                    child: Obx(() => controller.bookingDetailData!.data.villa
                            .villaGaleries.isNotEmpty
                        ? CachedNetworkImage(
                            fit: BoxFit.cover,
                            height: MediaQuery.of(context).size.height / 5,
                            width: MediaQuery.of(context).size.width,
                            imageUrl:
                                'http://10.0.2.2:3000/${controller.bookingDetailData!.data.villa.villaGaleries[0].imageName}',
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    controller.bookingDetailData!.data.villa
                                        .location.name,
                                    style: bodyMd(color: contextGrey),
                                  )
                                ],
                        ...
                        SizedBox(
                          ...
                          child: Row(
                            ...
                            children: [
                              CustomIconButton(
                                onTap: () {
                                  String phoneNumber = controller
                                      .bookingDetailData!.data.villa.phone;
                              ...
                              CustomIconButton(
                                  onTap: () {
                                    String mapsUrl = controller
                                        .bookingDetailData!.data.villa.mapUrl;
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              controller
                                  .bookingDetailData!.data.bookingStartDate,
                              style: bodyMd(
                                  color: contextOrange,
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Obx(() => Text(
                                        controller.bookingDetailData!.data
                                                    .status ==
                                                'settlement'
                                            ? 'TELAH DIBAYAR'
                                            : controller.bookingDetailData!.data
                                  ...
                                  Text(
                                    CurrencyFormatter.convertToIdr(
                                        controller
                                            .bookingDetailData!.data.totalPrice,
                                        2),
                                    style: h5(color: contextOrange),
                                  ),
                                  const SizedBox(height: 8),
                                  Row(
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: () {
                                          if (controller.bookingDetailData!.data
                                                  .payment.permataVaNumber !=
                                              null) {
                                          ...
                                          defaultSnackbar('Sukses!',
                                              'Nomor Virtual Account telah tersalin ke clipboard');
                                        },
                                ...
                                Obx(() {
                                  if (controller
                                    ...
                                    if (controller.bookingDetailData!.data
                                      ...
                                      DateTime expiryTime = controller
                                          .bookingDetailData!
                                          .data
                                          .payment
                                          .transactionTime
